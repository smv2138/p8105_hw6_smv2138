...
this variable from further analysis. They other 3 variables appear to
...
each other, and largely provide the same information, we will choose to
...
outliers or unequal variances. Furthermore, the graph was centered
around 0 and appear evenly spread out as well. Based on the density plot
of the residuals, we can see they are relatively normally distributed
and have a center of near 0 residuals. Therefore, we can assume that the
model is fit well and our assumptions are valid.
...
log(β<sup>0∗β</sup>1) values across all 5000 bootstrap resamples. The
density plot for the r squared was centered around 0.91. The density
plot for the log(β<sup>0∗β</sup>1) values was centered around 2.02.
These plots appear to be bell shaped however slightly left skewed.
...
| :--- | -------------: | -------------: | --------------: | --------------: |
| tmin |      0.8939268 |      0.9274707 |        1.966397 |        2.058816 |
